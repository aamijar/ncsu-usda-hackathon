...
# NeuralNetwork
model_path = './models/4_class_model_mobilenet_v3_large_data4_combined_class_weights_512x512_without_softmax.blob'
...
if camera:
    ...
    manip.initialConfig.setResize(512, 512)
