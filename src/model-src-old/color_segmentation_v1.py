...
#        cv2.putText(depthFrameColor, f"Z: {int(depthData.spatialCoordinates.z)} mm", (xmin + 10, ymin + 50), fontType, 0.5, 255)
    ...
    if in_nn is not None: ######Nueral Network Prediciton
        ...
        # debug indices
        print("clover---")
        print(clover_indices)
        print("broadl---")
        print(broadl_indices)
        # print("broadl shape", broadl_indices.shape)
        print("grass---")
        print(grass_indices)
        # print("grass shape", grass_indices.shape)
        ...
        try:
          ...
          # if g_Xmax == 0:
          #    g_Xmax = 1
          print(frame[g_Ymin:g_Ymax,g_Xmin:g_Xmax], g_Ymin, g_Ymax, g_Xmin, g_Xmax)
          
          
          g_exg, g_m_exg, g_sd_exg, g_exr, g_m_exr, g_sd_exr, g_sumdepth  = make_fv(frame[g_Ymin:g_Ymax,g_Xmin:g_Xmax],g_depth)
          print(g_exg, g_m_exg, g_sd_exg, g_exr, g_m_exr, g_sd_exr, g_sumdepth)
          ...
          print("cvals", c_Ymin, c_Ymax, c_Xmin, c_Xmax)
